...
<template>
  <div class="xtx-pay-checkout-page">
    <div class="container">
      <div class="wrapper">
        <!-- 收获地址 -->
        <h3 class="box-title">收获地址</h3>
        <div class="box-body">
          <div class="address">
            <div class="text">
              <div class="none" v-if="!curAddress">您需要先添加收获地址才可提交订单。</div>
              <ul v-else>
        ...
        <div class="box-body">
          <a href="javascript:;" class="my-btn active">不限送货时间：周一至周日</a>
        ...
        <div class="box-body">
          <a href="javascript:;" class="active my-btn">在线支付</a>
