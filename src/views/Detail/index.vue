    ...
    <div class="container" v-if="goods.details">
      <div class="bread-container">
        <el-breadcrumb separator=">">
          ...
          <!-- 首次渲报错原因，goods一开始为空对象{}  {}.categories  -> undefined  -> undefined[1] 
            解决方法： 1.可选链的语法？
          ...
          <el-breadcrumb-item>抓绒保暖，猫猫虫子儿童运动鞋</el-breadcrumb-item>
        </el-breadcrumb>
      </div>
      <!-- 商品信息 -->
      <div class="info-container">
        <div>
          <div class="goods-info">
            <div class="media">
              <!-- 图片预览区 -->
              <CatImageView :image-list="goods.mainPictures"></CatImageView>
              <!-- 统计数量 -->
              <ul class="goods-sales">
                ...
                <li>
                  ...
                  <p><i class="iconfont icon-task-filling">查看评价</i></p>
                </li>
                <li>
                  <p>收藏人气</p>
                  <p> {{ goods.collectCount }}+ </p>
                  <p><i class="iconfont icon-task-filling">收藏商品</i></p>
                </li>
                <li>
                  <p>品牌信息</p>
                  <p> {{ goods.brand.name }}+ </p>
                  <p><i class="iconfont icon-task-filling">品牌主页</i></p>
                </li>
              </ul>
            </div>
            <div class="spec">
              ...
              <!-- sku组件 -->
              <CatSku :goods="goods" @change="skuChange"></CatSku>
              <!-- 数据组件 -->
